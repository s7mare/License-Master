package top.gzii.license.common.utils;
...
public class RedisUtils {
    ...
    public static void del(String... key) {
        if (key != null && key.length > 0) {
            if (key.length == 1) {
                ...
                for (String s : key) {
                    redisUtils.redisTemplate.delete(s);
                }
     ...
     * @return
     */
    public static boolean lSetMIn(String key, Object value) {
        try {
     ...
     * @return
     */
    public static Object lPop(String key, long index) {
        try {
            Object o = redisUtils.redisTemplate.opsForList().leftPop(key, index, TimeUnit.SECONDS);
            return o;
        } catch (Exception e) {
            e.printStackTrace();
            return null;
